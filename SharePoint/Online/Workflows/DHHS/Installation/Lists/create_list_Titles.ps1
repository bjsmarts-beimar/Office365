...
$listItemInfo = New-Object Microsoft.SharePoint.Client.ListItemCreationInformation
$item = $list.AddItem($listItemInfo)
$item["Title"] = "EEMS Workaround View Form"
$item["TitleID"] = 2
$item["titleForm"] = "EEMS Temporary Process Change (TPC) View Form"
$item.Update()
$Context.ExecuteQuery()
...
$listItemInfo = New-Object Microsoft.SharePoint.Client.ListItemCreationInformation
$item = $list.AddItem($listItemInfo)
$item["Title"] = "EEMS Workaround Resubmit Form"
$item["TitleID"] = 3
$item["titleForm"] = "EEMS Temporary Process Change (TPC) Resubmit"
$item.Update()
$Context.ExecuteQuery()
...
$listItemInfo = New-Object Microsoft.SharePoint.Client.ListItemCreationInformation
$item = $list.AddItem($listItemInfo)
$item["Title"] = "EEMS Workaround Approval Form"
$item["TitleID"] = 4
$item["titleForm"] = "EEMS Temporary Process Change (TPC) Approval Form"
$item.Update()
$Context.ExecuteQuery()
...
$listItemInfo = New-Object Microsoft.SharePoint.Client.ListItemCreationInformation
$item = $list.AddItem($listItemInfo)
$item["Title"] = "EEMS Workaround Final Form"
$item["TitleID"] = 5
$item["titleForm"] = "EEMS Temporary Process Change (TPC) Final Form"
$item.Update()
$Context.ExecuteQuery()
