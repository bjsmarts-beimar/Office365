...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	<SharePoint:CssRegistration name="/sites/avicia/_catalogs/masterpage/Avicia/css/Avicia.css" runat="server" />
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	...
	<article>
		<div class="container">
            ...
            <div class="eight columns">
            	<PublishingWebControls:RichHtmlField FieldName="SBWPageContent1" HasInitialFocus="False" MinimumEditHeight="300px" InputFieldLabel="Right Page Content" runat="server"/>
            </div>
