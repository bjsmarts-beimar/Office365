...
$listCreationInformation.Title = "NON-MAGI"
$listCreationInformation.Description = "NON-MAGI Form created through PowerShell"
...
#DeskReferenceLink - Text Field 
$list.Fields.AddFieldAsXml("<Field Type='Text' DisplayName='DeskReferenceLink' Name='DeskReferenceLink' StaticName='DeskReferenceLink' />",$true,[Microsoft.SharePoint.Client.AddFieldOptions]::AddFieldToDefaultView)
$list.Update()
$context.ExecuteQuery()
