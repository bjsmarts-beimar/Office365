...
function loadingAccordion1()
{
       ...
       $().SPServices({
            ...
            CAMLQuery: "<Query><Where><And><Eq><FieldRef Name='Display_x0020_Area' /><Value Type='String'>Announcements</Value></Eq><Geq><FieldRef Name='Expires' /><Value Type='DateTime'><Today/></Value></Geq></And></Where><OrderBy><FieldRef Name='Modified' Ascending='FALSE' /></OrderBy></Query>",
