        ...
        completefunc: function (xData, Status) {
            ...
            $(xData.responseXML).SPFilterNode("z:row").each(function() {
                ...
                if ( index < 2 ) {       
                    ...
                    var dateStr=$(this).attr("ows_Post_x0020_Date"); 
                    var a=dateStr.split(" ");
                    var d=a[0].split("-");
                    var t=a[1].split(":");
                    var myDate = new Date(d[0],(d[1]-1),d[2],t[0],t[1],t[2]);

                    SliHtml = SliHtml + "<tr><td><span class='ms-announcementtitle'><a href='/Lists/Announcements/DispForm.aspx?ID=" + Id + "&Source=https://team.scdhhs.gov/'>" + Title + "</a></spam></td></tr>";
                    SliHtml = SliHtml + "<tr><td>" + dateFormatUTC(myDate) + "</td></tr>";
                    
                    console.log('after: ', mainBody);
                    
                    // var dataHtml = $($.parseXML(mainBody)).children('html');                    
                    // var longText = dataHtml.context.documentElement.textContent;
                    // var shortText = dataHtml.context.documentElement.textContent.slice(0, 220);
