...
$(document).on("ready", function(){
  ...
  console.log("maxActive test = {{maxActiveTest}}, inProgressTest={{inProgressTest}}, unfufilledNumberofTestOrders={{unfufilledNumberofTests}}, Test order items={{TestOrderItems}}, patientTest={{patientTest}}, testKitsRemaining= {{testKitsRemaining}}");
